...
class IsItMe:
    def __init__(self):
        ...
        self.predictor = dlib.shape_predictor("core/src/main/java/com/mda/Python/models/shape_predictor_68_face_landmarks.dat")
        self.facerec = dlib.face_recognition_model_v1("core/src/main/java/com/mda/Python/models/dlib_face_recognition_resnet_model_v1.dat")
        ...
        self.my_photo_paths = [
            ["core/src/main/java/com/mda/Python/faces/1.jpeg"],
            ["core/src/main/java/com/mda/Python/faces/2.jpeg"],
        ]
    ...
    def get_face_embedding(self, img_path):
        ...
        if img is None or img.size == 0:
            ...
            f = open("core/src/main/java/com/mda/Python/Connection.txt", "w")
            f.write("error")
            f.close()
            return None
